...
@triton.jit
def triton_broadcast_to_dim1(in_ptr0, out_ptr0, L: tl.constexpr,
    ...
    idx = lblk_idx[:, None, None]*N*1 + \
        tl.arange(0, 1)[None, :, None]*N+nblk_idx[None, None, :]
...
def test_broadcast_to_1(sigtype, L, M, N):
    """
    _summary_
    ...
    x0 = test_common.generate_tensor(shape=(L, 1, N), dtype=sigtype).npu()
    ans = x0.repeat(1, M, 1)
