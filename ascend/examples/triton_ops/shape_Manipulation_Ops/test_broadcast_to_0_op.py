...
@triton.jit
def triton_broadcast_to_dim0(in_ptr0, out_ptr0, L: tl.constexpr,
    ...
    idx = tl.arange(0, 1)[:, None, None]*N*M + \
...
def test_broadcast_to_0(sigtype, L, M, N):
    """
    _summary_
    ...
    x0 = test_common.generate_tensor(shape=(1, M, N), dtype=sigtype).npu()
    ans = x0.repeat(L, 1, 1)
