...
@triton.jit
def triton_trans_3_102(output_ptr, x_ptr, XB: tl.constexpr, YB: tl.constexpr,
                       ZB: tl.constexpr):
    """
    _summary_
...
def test_trans_3_102(sigtype, XB, YB, ZB):
    """
    _summary_
    ...
    triton_trans_3_102[1, 1, 1](output, x0, XB, YB, ZB)
