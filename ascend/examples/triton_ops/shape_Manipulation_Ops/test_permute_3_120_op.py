...
@triton.jit
def triton_permute_3_120(output_ptr, x_ptr, XB: tl.constexpr, YB: tl.constexpr,
                         ZB: tl.constexpr):
    """
    _summary_
...
def test_permute_3_120(sigtype, XB, YB, ZB):
    """
    _summary_
    ...
    triton_permute_3_120[1, 1, 1](output, x0, XB, YB, ZB)
