...
@triton.jit
def triton_atomic_max(in_ptr0, out_ptr0, L: tl.constexpr, M: tl.constexpr,
                      N: tl.constexpr):
    """_summary_
...
def test_atomic_max(sigtype, L, M, N):
    """_summary_
    ...
    ans = torch.maximum(x0, output)
    triton_atomic_max[1, 1, 1](x0, output, L, M, N)
