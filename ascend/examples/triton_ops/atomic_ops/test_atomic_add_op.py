...
@triton.jit
def triton_atomic_add(in_ptr0, out_ptr0, L: tl.constexpr, M: tl.constexpr,
                      N: tl.constexpr):
    """_summary_
...
def test_atomic_add(sigtype, L, M, N):
    """_summary_
    ...
    ans = x0 + output
    triton_atomic_add[1, 1, 1](x0, output, L, M, N, debug=True)
