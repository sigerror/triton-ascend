...
def softmax_kernel(output_ptr, input_ptr, input_row_stride, output_row_stride,
    ...
    :param output_ptr: 
    :param input_ptr: 
    :param input_row_stride: 
    :param output_row_stride: 
    :param n_rows: 
    :param n_cols: 
    :param BLOCK_SIZE: 
    """
...
def softmax(x, stream):
    ...
    kernel[(num_programs, 1, 1)](y, x, x.stride(0), y.stride(0), n_rows,
                                 n_cols, BLOCK_SIZE)
    return y
...
@pytest.mark.parametrize('M, N', shapelist)
def test_num_programs(sigtype, M, N):
    """_summary_
