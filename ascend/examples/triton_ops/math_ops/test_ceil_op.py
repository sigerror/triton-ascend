...
@triton.jit
def triton_ceil(in_ptr0, out_ptr0, L: tl.constexpr, M: tl.constexpr, N: tl.constexpr):
    """
...
def test_ceil(sigtype, L, M, N):
    ...
    triton_ceil[1, 1, 1](x0, output, L, M, N)
