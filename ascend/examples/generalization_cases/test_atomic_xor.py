...
@triton.jit
def atomic_xor_5d(x_ptr, out_ptr, XB: tl.constexpr, YB: tl.constexpr, ZB: tl.constexpr, MB: tl.constexpr, NB: tl.constexpr,
    ...
    tl.atomic_xor(out_ptr + offsets1, tmp0)
...
@pytest.mark.parametrize('x_dtype_str', filtered_dtype)
def test_atomic_xor_5d(x_dtype_str, param_list):
...
@triton.jit
def atomic_xor_4d(x_ptr, out_ptr, XB: tl.constexpr, YB: tl.constexpr, ZB: tl.constexpr, MB: tl.constexpr,
...
@pytest.mark.parametrize('x_dtype_str', filtered_dtype)
def test_atomic_xor_4d(x_dtype_str, param_list):
    x0_shape, y_shape = param_list
...
@triton.jit
def atomic_xor_3d(x_ptr, out_ptr, XB: tl.constexpr, YB: tl.constexpr, ZB: tl.constexpr,
...
@pytest.mark.parametrize('x_dtype_str', filtered_dtype)
def test_atomic_xor_3d_2(x_dtype_str, param_list):
    x0_shape, y_shape = param_list
...
@triton.jit
def atomic_xor_2d(x_ptr, out_ptr, XB: tl.constexpr, YB: tl.constexpr,
...
@pytest.mark.parametrize('x_dtype_str', filtered_dtype)
def test_atomic_xor_2d(x_dtype_str, param_list):
    x0_shape, y_shape = param_list
