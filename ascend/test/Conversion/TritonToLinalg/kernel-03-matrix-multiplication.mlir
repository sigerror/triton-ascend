...
// CHECK-SAME:   (%[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, [[PARAM_0_:%.+]]: memref<?xbf16>, [[PARAM_1_:%.+]]: memref<?xbf16>, [[PARAM_2_:%.+]]: memref<?xbf16> {tt.tensor_kind = 1 : i32}, [[PARAM_3_:%.+]]: i32, [[PARAM_4_:%.+]]: i32, [[PARAM_5_:%.+]]: i32, [[PARAM_6_:%.+]]: i32, [[PARAM_7_:%.+]]: i32, [[PARAM_8_:%.+]]: i32, [[PARAM_9_:%.+]]: i32, [[PARAM_10_:%.+]]: i32, [[PARAM_11_:%.+]]: i32, [[PARAM_12_:%.+]]: i32, [[PARAM_13_:%.+]]: i32, [[PARAM_14_:%.+]]: i32, [[PARAM_15_:%.+]]: i32, [[PARAM_16_:%.+]]: i32, [[PARAM_17_:%.+]]: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "mix"} {
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_16_:%.+]] = arith.divsi [[VAR_15_]], [[VAR_12_1]] : i32
...
// CHECK:             [[VAR_55_:%.+]] = linalg.matmul {input_precison = "tf32"} ins([[VAR_51_]], [[VAR_52_]] : tensor<128x64xbf16>, tensor<64x256xbf16>) outs([[VAR_1_]] : tensor<128x256xf32>) -> tensor<128x256xf32>
// CHECK:             [[VAR_57_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins([[VAR_arg19_]], [[VAR_55_]] : tensor<128x256xf32>, tensor<128x256xf32>) outs([[VAR_arg19_]] : tensor<128x256xf32>) {
...
// CHECK-DAG:       [[VAR_33_:%.+]] = arith.muli [[VAR_19_]], [[VAR_32_]] : index
// CHECK-DAG:       [[VAR_34_:%.+]] = arith.index_cast [[PARAM_11_]] : i32 to index
// CHECK-DAG:       [[VAR_35_:%.+]] = arith.muli [[VAR_24_]], [[VAR_34_]] : index
// CHECK:           [[VAR_38_:%.+]] = arith.addi [[VAR_33_]], [[VAR_35_]] : index
// CHECK-DAG:       [[VAR_reinterpret_cast_1_:%.+]] = memref.reinterpret_cast [[PARAM_2_]] to offset: {{.}}[[VAR_38_]]{{.}}, sizes: [128, 256], strides: {{.}}[[VAR_32_]], [[VAR_34_]]{{.}} : memref<?xbf16> to memref<128x256xbf16, strided<[?, ?], offset: ?>>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_40_:%.+]] = arith.addi [[VAR_19_]], [[CST_128_]] : index
// CHECK-DAG:       [[VAR_41_:%.+]] = arith.index_cast [[PARAM_3_]] : i32 to index
// CHECK:           [[VAR_42_0_:%.+]] = arith.maxsi [[VAR_19_]], [[VAR_41_]] : index
// CHECK:           [[VAR_42_:%.+]] = arith.minsi [[VAR_40_]], [[VAR_42_0_]] : index
// CHECK-DAG:       [[VAR_43_:%.+]] = arith.subi [[VAR_42_]], [[VAR_19_]] : index
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_45_:%.+]] = arith.addi [[VAR_24_]], [[CST_256_]] : index
// CHECK-DAG:       [[VAR_46_:%.+]] = arith.index_cast [[PARAM_4_]] : i32 to index
// CHECK:           [[VAR_47_0_:%.+]] = arith.maxsi [[VAR_24_]], [[VAR_46_]] : index
// CHECK:           [[VAR_47_:%.+]] = arith.minsi [[VAR_45_]], [[VAR_47_0_]] : index
// CHECK-DAG:       [[VAR_48_:%.+]] = arith.subi [[VAR_47_]], [[VAR_24_]] : index
