...
// CHECK-SAME:      %[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, %[[VAL_0:.*]]: memref<?xi1> {tt.tensor_kind = 0 : i32}, %[[VAL_1:.*]]: memref<?xf32> {tt.tensor_kind = 0 : i32},  %[[VAL_2:.*]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, %[[VAL_3:.*]]: memref<128x128xf32>,
