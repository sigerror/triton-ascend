...
// CHECK:           memref.copy %[[VAL_15]], %[[VAL_16]] : memref<4x256xbf16, strided<[2, 10], offset: ?>> to memref<4x256xbf16>
...
// CHECK:           %[[VAL_25:.*]] = arith.addi %[[VAL_14]], %[[VAL_8]] : index
// CHECK:           %[[VAL_28:.*]] = memref.reinterpret_cast %[[VAL_0]] to offset: {{\[}}%[[VAL_25]]], sizes: [4, 256], strides: [3, 15] : memref<?xbf16> to memref<4x256xbf16, strided<[3, 15], offset: ?>>
