...
// CHECK-SAME:   (%[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, [[PARAM_0_:%.+]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, [[PARAM_1_:%.+]]: memref<?xi32> {tt.tensor_kind = 1 : i32}, [[PARAM_2_:%.+]]: i32,  %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"} {
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : i32
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0xFF800000 : f32
// CHECK-DAG:       [[VAR_0_:%.+]] = arith.muli %arg8, [[PARAM_2_]] : i32
...
// CHECK-DAG:           [[VAR_10_1_:%.+]] = arith.cmpf ogt, [[in]], [[init]] : f32
// CHECK-DAG:           [[VAR_11_1_:%.+]] = arith.cmpf oeq, [[in]], [[init]] : f32
// CHECK-DAG:           [[VAR_12_1_:%.+]] = arith.cmpi slt, [[in_1]], [[init_2]] : i32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_13_:%.+]] = arith.andi [[VAR_11_1_]], [[VAR_12_1_]] : i1
// CHECK:               [[VAR_14_:%.+]] = arith.ori [[VAR_10_1_]], [[VAR_13_]] : i1
...
// CHECK:             }
// CHECK:           [[VAR_extracted_:%.+]] = tensor.extract [[VAR_reduced_]]#1[] : tensor<i32>
// CHECK-DAG:       [[VAR_9_:%.+]] = arith.index_cast %arg8 : i32 to index
// CHECK:           [[VAR_17_:%.+]] = tensor.empty() : tensor<1xi32>
// CHECK:           [[VAR_18_:%.+]] = linalg.fill ins([[VAR_extracted_]] : i32) outs([[VAR_17_]] : tensor<1xi32>) -> tensor<1xi32>
...
// CHECK:           bufferization.materialize_in_destination [[VAR_18_]] in writable [[VAR_reinterpret_cast_0_]] : (tensor<1xi32>, memref<1xi32, strided<[1], offset: ?>>) -> ()
// CHECK:           return
// CHECK:         }
...
// CHECK:           [[VAR_reduced_:%.+]]:2 = linalg.reduce ins([[VAR_4_]], [[VAR_2_]] : tensor<4096xf32>, tensor<4096xi32>) outs([[VAR_6_]], [[VAR_8_]] : tensor<f32>, tensor<i32>) dimensions = [0]
// CHECK:             ([[in:.+]]: f32, [[in_1:.+]]: i32, [[init:.+]]: f32, [[init_2:.+]]: i32) {
// CHECK-DAG:           [[VAR_10_1_:%.+]] = arith.cmpf olt, [[in]], [[init]] : f32
// CHECK-DAG:           [[VAR_11_1_:%.+]] = arith.cmpf oeq, [[in]], [[init]] : f32
// CHECK-DAG:           [[VAR_12_1_:%.+]] = arith.cmpi slt, [[in_1]], [[init_2]] : i32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_13_:%.+]] = arith.andi [[VAR_11_1_]], [[VAR_12_1_]] : i1
