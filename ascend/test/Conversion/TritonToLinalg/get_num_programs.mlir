...
// CHECK:     %1 = linalg.fill ins(%arg3 : i32) outs(%0 : tensor<1xi32>) -> tensor<1xi32>
...
// CHECK:     %2 = linalg.fill ins(%arg4 : i32) outs(%0 : tensor<1xi32>) -> tensor<1xi32>
...
// CHECK:     %3 = linalg.fill ins(%arg5 : i32) outs(%0 : tensor<1xi32>) -> tensor<1xi32>
