...
// CHECK-SAME:      %[[VAL_2:.*]]: i32, %[[VAL_3:.*]]: i32, %[[ARG_6:.*]]: i32, %[[ARG_7:.*]]: i32, %[[ARG_8:.*]]: i32, %[[ARG_9:.*]]: i32, %[[ARG_10:.*]]: i32, %[[ARG_11:.*]]: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"}  {
...
// CHECK:           %[[VAL_13:.*]] = memref.reinterpret_cast %[[VAL_0]] to offset: {{\[}}%[[VAL_12]]], sizes: [4, 256], strides: [1, 6] : memref<?xbf16> to memref<4x256xbf16, strided<[1, 6], offset: ?>>
// CHECK:           %[[VAL_18:.*]] = memref.reinterpret_cast %[[VAL_1]] to offset: {{\[}}%[[VAL_12]]], sizes: [4, 256], strides: [1, 6] : memref<?xbf16> to memref<4x256xbf16, strided<[1, 6], offset: ?>>
...
// CHECK:           annotation.mark %[[VAL_20]] {MayImplicitTransposeWithLastAxis} : tensor<4x256xbf16>
