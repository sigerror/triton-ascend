...
// CHECK-DAG:       [[CST_0_index_:%.+]] = arith.constant 0 : index
// CHECK-DAG:       [[VAR_0_:%.+]] = arith.muli %arg10, [[PARAM_2_]] : i32
...
// CHECK:           [[VAR_3_0_:%.+]] = arith.maxsi [[VAR_2_]], [[CST_0_index_]] : index
// CHECK:           [[VAR_3_:%.+]] = arith.minsi [[VAR_3_0_]], [[CST_128_]] : index
...
// CHECK:           [[VAR_inserted_2_:%.+]] = linalg.fill ins([[CST]] : f32) outs([[VAR_11_]] : tensor<f32>) -> tensor<f32>
...
// CHECK:           [[VAR_13_:%.+]] = linalg.fill ins([[VAR_extracted_4_]] : f32) outs([[VAR_7_]] : tensor<128xf32>) -> tensor<128xf32>
...
// CHECK:           } -> tensor<128xf32>
// CHECK:           [[VAR_15_:%.+]] = arith.muli %arg10, [[PARAM_3_]] : i32
...
// CHECK-DAG:       [[VAR_extracted_slice_:%.+]] = tensor.extract_slice [[VAR_14_]][0] [[[VAR_3_]]] [1] : tensor<128xf32> to tensor<?xf32>
// CHECK-DAG:       [[VAR_subview_6_:%.+]] = memref.subview [[VAR_reinterpret_cast_5_]][0] {{.}}[[VAR_3_]]{{.}} [1]{{.*}} : memref<128xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
// CHECK:           bufferization.materialize_in_destination [[VAR_extracted_slice_]] in writable [[VAR_subview_6_]]
// CHECK:           return
// CHECK:         }
