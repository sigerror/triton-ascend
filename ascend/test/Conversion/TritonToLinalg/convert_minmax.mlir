...
// CHECK:  %[[VAL:.*]] = arith.cmpf olt, [[ARG_1:%.+]], [[ARG_2:%.+]] : f32
...
// CHECK:  %[[VAL:.*]] = arith.cmpf ole, [[ARG_1:%.+]], [[ARG_2:%.+]] : f32
...
// CHECK:  %[[VAL:.*]] = arith.cmpf ogt, [[ARG_1:%.+]], [[ARG_2:%.+]] : f32
...
// CHECK:  %[[VAL:.*]] = arith.cmpf oge, [[ARG_1:%.+]], [[ARG_2:%.+]] : f32
