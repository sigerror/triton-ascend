...
// CHECK-SAME:   (%[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, [[PARAM_0_:%.+]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, [[PARAM_1_:%.+]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, [[PARAM_2_:%.+]]: memref<?xf32> {tt.tensor_kind = 1 : i32}, [[PARAM_3_:%.+]]: memref<?xf32> {tt.tensor_kind = 1 : i32}, [[PARAM_4_:%.+]]: i32, [[PARAM_5_:%.+]]: i32, [[PARAM_6_:%.+]]: i32, [[PARAM_7_:%.+]]: i32, [[PARAM_8_:%.+]]: i32, [[PARAM_9_:%.+]]: i32, [[PARAM_10_:%.+]]: i32, [[PARAM_11_:%.+]]: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"} {
...
// CHECK-DAG:       [[VAR_2_:%.+]] = arith.muli [[PARAM_9_]], [[CST_256_1_]] : i32
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_26_:%.+]] = arith.addi [[VAR_20_]], [[CST_256_]] : index
// CHECK-DAG:         [[VAR_27_:%.+]] = arith.index_cast [[PARAM_4_]] : i32 to index
// CHECK:             [[VAR_28_0_:%.+]] = arith.maxsi [[VAR_20_]], [[VAR_27_]] : index
// CHECK:             [[VAR_28_:%.+]] = arith.minsi [[VAR_26_]], [[VAR_28_0_]] : index
// CHECK-DAG:         [[VAR_29_:%.+]] = arith.subi [[VAR_28_]], [[VAR_20_]] : index
// CHECK-DAG:         [[VAR_31_:%.+]] = arith.addi [[VAR_23_]], [[CST_256_]] : index

// CHECK:             [[VAR_33_0_:%.+]] = arith.maxsi [[VAR_23_]], [[VAR_21_]] : index
// CHECK:             [[VAR_33_:%.+]] = arith.minsi [[VAR_31_]], [[VAR_33_0_]] : index

// CHECK-DAG:         [[VAR_34_:%.+]] = arith.subi [[VAR_33_]], [[VAR_23_]] : index
...
// CHECK-DAG:         [[VAR_reinterpret_cast_7_:%.+]] = memref.reinterpret_cast [[PARAM_1_]] to offset: {{.}}[[VAR_24_]]{{.}}, sizes: [256, 256], strides: [[[VAR_21_]], 1] : memref<?xf32> to memref<256x256xf32, strided<[?, 1], offset: ?>>
...
// CHECK:             }
// CHECK-DAG:         [[VAR_subview_9_:%.+]] = memref.subview [[VAR_reinterpret_cast_7_]][0, 0] {{.}}[[VAR_35_]], [[VAR_36_]]{{.}} [1, 1] : memref<256x256xf32, strided<[?, 1], offset: ?>> to memref<?x?xf32, strided<[?, 1], offset: ?>>
// CHECK-DAG:         [[VAR_subview_10_:%.+]] = memref.subview [[RES_1_]][0, 0] {{.}}[[VAR_35_]], [[VAR_36_]]{{.}} [1, 1] : memref<256x256xf32> to memref<?x?xf32, strided<[256, 1]>>
...
// CHECK:           [[VAR_reduced_0_:%.+]] = linalg.reduce ins([[VAR_3_]]#1 : tensor<256x256xf32>) outs([[VAR_5_]] : tensor<256xf32>) dimensions = [0]
// CHECK:             ([[in_0:.+]]: f32, [[in_1:.+]]: f32) {
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_10_:%.+]] = arith.addi [[VAR_8_]], [[CST_256_]] : index
// CHECK-DAG:       [[VAR_11_:%.+]] = arith.index_cast [[PARAM_5_]] : i32 to index
// CHECK:           [[VAR_12_0_:%.+]] = arith.maxsi [[VAR_8_]], [[VAR_11_]] : index
// CHECK:           [[VAR_12_:%.+]] = arith.minsi [[VAR_10_]], [[VAR_12_0_]] : index
// CHECK:           [[VAR_13_:%.+]] = arith.subi [[VAR_12_]], [[VAR_8_]] : index
...
// CHECK-DAG:       [[VAR_reinterpret_cast_1_:%.+]] = memref.reinterpret_cast [[PARAM_3_]] to offset: {{.}}[[VAR_8_]]{{.}}, sizes: [256], strides: [1] : memref<?xf32> to memref<256xf32, strided<[1], offset: ?>>
// CHECK-DAG:       [[VAR_extracted_slice_2_:%.+]] = tensor.extract_slice [[VAR_reduced_0_]][0] {{.}}[[VAR_13_]]{{.}} [1] : tensor<256xf32> to tensor<?xf32>
// CHECK-DAG:       [[VAR_subview_3_:%.+]] = memref.subview [[VAR_reinterpret_cast_1_]][0] {{.}}[[VAR_13_]]{{.}} [1] : memref<256xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
// CHECK:           bufferization.materialize_in_destination [[VAR_extracted_slice_2_]] in writable [[VAR_subview_3_]]
// CHECK:           return
// CHECK:         }
