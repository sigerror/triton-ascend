...
// CHECK-SAME:      %[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, %[[VAL_0:.*]]: memref<?xf32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32},  %[[VAL_1:.*]]: memref<?xf32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32},
// CHECK-SAME:      %[[VAL_2:.*]]: i32, %[[VAL_3:.*]]: i32, %[[VAL_4:.*]]: i32, %[[ARG_7:.*]]: i32, %[[ARG_8:.*]]: i32, %[[ARG_9:.*]]: i32, %[[ARG_10:.*]]: i32, %[[ARG_11:.*]]: i32, %[[ARG_12:.*]]: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"} {
// CHECK:           %[[VAL_8:.*]] = arith.muli %[[ARG_10]], %[[VAL_2]] : i32
// CHECK:           %[[VAL_9:.*]] = arith.index_cast %[[VAL_8]] : i32 to index
// CHECK:           %[[VAL_10:.*]] = arith.muli %[[ARG_10]], %[[VAL_3]] : i32
// CHECK:           %[[VAL_11:.*]] = arith.index_cast %[[VAL_10]] : i32 to index
// CHECK:           %[[VAL_12:.*]] = arith.addi %[[VAL_9]], %[[VAL_11]] : index
// CHECK:           %[[VAL_13:.*]] = arith.muli %[[ARG_10]], %[[VAL_4]] : i32
// CHECK:           %[[VAL_14:.*]] = arith.index_cast %[[VAL_13]] : i32 to index
// CHECK:           %[[VAL_15:.*]] = arith.addi %[[VAL_12]], %[[VAL_14]] : index
...
// CHECK:           %[[VAL_25:.*]] = memref.reinterpret_cast %[[VAL_0]] to offset: {{\[}}%[[VAL_11]]], sizes: [1024], strides: [1] : memref<?xf32> to memref<1024xf32, strided<[1], offset: ?>>
// CHECK:           bufferization.materialize_in_destination %[[VAL_19:.*]] in writable %[[VAL_25]]
// CHECK:           return
// CHECK:         }
