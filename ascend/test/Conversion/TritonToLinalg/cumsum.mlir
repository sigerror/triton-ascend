...
// CHECK-SAME:   (%[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, [[PARAM_0_:%.+]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, [[PARAM_1_:%.+]]: memref<?xi32> {tt.tensor_kind = 1 : i32}, 
// CHECK-SAME:   [[PARAM_2_:%.+]]: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"} {
// CHECK-DAG:    [[FALSE:%.+]] = arith.constant false
// CHECK-DAG:    [[C0_i32:%.+]] = arith.constant 0 : i32
// CHECK:        [[VAR_0_:%.+]] = arith.muli %arg8, [[PARAM_2_]] : i32
...
// CHECK-DAG:       [[VAR_4_:%.+]] = call @triton_cumsum([[VAR_2_]], [[C0_i32]], %false) : (tensor<4096xf32>, i32, i1) -> tensor<4096xf32>
