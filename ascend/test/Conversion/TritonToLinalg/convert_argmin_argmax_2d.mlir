...
// CHECK-SAME:   (%[[ARG_0:.*]]: memref<?xi8>, %[[ARG_1:.*]]: memref<?xi8>, [[PARAM_0_:%.+]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, [[PARAM_1_:%.+]]: memref<?xf32> {tt.tensor_kind = 1 : i32}, [[PARAM_2_:%.+]]: i32, [[PARAM_3_:%.+]]: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "", mix_mode = "aiv"} {
...
// CHECK-DAG:           [[VAR_13_:%.+]] = arith.cmpf ogt, [[in_]], [[init]] : f32
// CHECK-DAG:           [[VAR_14_1_:%.+]] = arith.cmpf oeq, [[in_]], [[init]] : f32
// CHECK-DAG:           [[VAR_15_1_:%.+]] = arith.cmpi slt, [[in_1_]], [[init_2]] : i32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_16_:%.+]] = arith.andi [[VAR_14_1_]], [[VAR_15_1_]] : i1
// CHECK:               [[VAR_17_:%.+]] = arith.ori [[VAR_13_]], [[VAR_16_]] : i1
...
// CHECK:           [[VAR_12_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_reduced_]]#1 : tensor<4xi32>) outs([[VAR_7_]] : tensor<4xf32>) {
...
// CHECK:           [[VAR_reduced_:%.+]]:2 = linalg.reduce ins([[VAR_4_]], [[VAR_6_]] : tensor<4x4xf32>, tensor<4x4xi32>) outs([[VAR_8_]], [[VAR_10_]] : tensor<4xf32>, tensor<4xi32>) dimensions = [1]
// CHECK:             ([[in_:.+]]: f32, [[in_1_:.+]]: i32, [[init:.+]]: f32, [[init_2:.+]]: i32) {
// CHECK-DAG:           [[VAR_13_:%.+]] = arith.cmpf olt, [[in_]], [[init]] : f32
// CHECK-DAG:           [[VAR_14_1_:%.+]] = arith.cmpf oeq, [[in_]], [[init]] : f32
// CHECK-DAG:           [[VAR_15_1_:%.+]] = arith.cmpi slt, [[in_1_]], [[init_2]] : i32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_16_:%.+]] = arith.andi [[VAR_14_1_]], [[VAR_15_1_]] : i1
