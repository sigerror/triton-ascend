...
// CHECK-SAME:          %[[VAL_0:.*]]: memref<?xf32> {tt.tensor_kind = 0 : i32}, %[[VAL_1:.*]]: memref<?xf32> {tt.tensor_kind = 1 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32)
...
// CHECK:           %[[VAL_7:.*]] = memref.reinterpret_cast %[[VAL_0]] to offset: [0], sizes: [512, 256], strides: [256, 1] : memref<?xf32> to memref<512x256xf32, strided<[256, 1]>>
...
// CHECK:           memref.copy %[[VAL_7]], %[[VAL_9]] : memref<512x256xf32, strided<[256, 1]>> to memref<512x256xf32>
...
// CHECK:           %[[VAL_15:.*]] = linalg.reduce ins(%[[VAL_10]] : tensor<512x256xf32>) outs(%[[VAL_14]] : tensor<512xf32>) dimensions = [1]
