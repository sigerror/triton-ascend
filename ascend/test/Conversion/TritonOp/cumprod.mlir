...
// CHECK: func.func private @triton_cumprod_0(tensor<8xi8>, i32, i1) -> tensor<8xi8>
...
// CHECK: %{{.*}} = call @triton_cumprod_0(%[[TENSOR]], %c0_i32, %false) : (tensor<8xi8>, i32, i1) -> tensor<8xi8>
...
// CHECK: func.func private @triton_cumprod_0(tensor<8xi16>, i32, i1) -> tensor<8xi16>
// CHECK: %false = arith.constant false
// CHECK: %c0_i32 = arith.constant 0 : i32
...
// CHECK: %{{.*}} = call @triton_cumprod_0(%[[TENSOR]], %c0_i32, %false) : (tensor<8xi16>, i32, i1) -> tensor<8xi16>
// CHECK: bufferization.materialize_in_destination
...
// CHECK: func.func private @triton_cumprod_0(tensor<8xi32>, i32, i1) -> tensor<8xi32>
// CHECK: %false = arith.constant false
// CHECK: %c0_i32 = arith.constant 0 : i32
...
// CHECK: %{{.*}} = call @triton_cumprod_0(%[[TENSOR]], %c0_i32, %false) : (tensor<8xi32>, i32, i1) -> tensor<8xi32>
// CHECK: bufferization.materialize_in_destination
...
// CHECK: func.func private @triton_cumprod_0(tensor<8xi64>, i32, i1) -> tensor<8xi64>
// CHECK: %false = arith.constant false
// CHECK: %c0_i32 = arith.constant 0 : i32
...
// CHECK: %{{.*}} = call @triton_cumprod_0(%[[TENSOR]], %c0_i32, %false) : (tensor<8xi64>, i32, i1) -> tensor<8xi64>
// CHECK: bufferization.materialize_in_destination