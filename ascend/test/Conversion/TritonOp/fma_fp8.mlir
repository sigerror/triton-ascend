...
module {
		...
		%39 = math.fma %32, %35, %38 : tensor<2x29x4xf8E4M3FN>
		%40 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%41 = tt.addptr %40, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %41, %39 : tensor<2x29x4x!tt.ptr>
		tt.return
	}
}

// CHECK: %[[ALLOC_OP1:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E4M3FN>
// CHECK: %[[TENSOR_OP1:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP1]] restrict writable : memref<2x29x4xf8E4M3FN>

// CHECK: %[[ALLOC_OP2:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E4M3FN>
// CHECK: %[[TENSOR_OP2:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP2]] restrict writable : memref<2x29x4xf8E4M3FN>

// CHECK: %[[ALLOC_OP3:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E4M3FN>
// CHECK: %[[TENSOR_OP3:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP3]] restrict writable : memref<2x29x4xf8E4M3FN>

// CHECK: %[[FMA_RESULT:[A-Za-z0-9_]+]] = math.fma %[[TENSOR_OP1]], %[[TENSOR_OP2]], %[[TENSOR_OP3]] : tensor<2x29x4xf8E4M3FN>
...
module {
		...
		%37 = tt.addptr %36, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		%38 = tt.load %37 : tensor<2x29x4x!tt.ptr>
		%39 = math.fma %32, %35, %38 : tensor<2x29x4xf8E5M2>
		%40 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%41 = tt.addptr %40, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %41, %39 : tensor<2x29x4x!tt.ptr>
		tt.return
...
// CHECK: %[[ALLOC_OP1:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E5M2>
// CHECK: %[[TENSOR_OP1:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP1]] restrict writable : memref<2x29x4xf8E5M2>

// CHECK: %[[ALLOC_OP2:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E5M2>
// CHECK: %[[TENSOR_OP2:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP2]] restrict writable : memref<2x29x4xf8E5M2>

// CHECK: %[[ALLOC_OP3:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E5M2>
// CHECK: %[[TENSOR_OP3:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_OP3]] restrict writable : memref<2x29x4xf8E5M2>

// CHECK: %[[FMA_RESULT:[A-Za-z0-9_]+]] = math.fma %[[TENSOR_OP1]], %[[TENSOR_OP2]], %[[TENSOR_OP3]] : tensor<2x29x4xf8E5M2>