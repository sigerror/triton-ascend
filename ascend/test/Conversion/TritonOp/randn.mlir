...
module {
  tt.func public @kernel_randn(%arg0: !tt.ptr<bf16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %cst_2 = arith.constant 1.000000e-07 : f32
    ...
    scf.for %arg1 = %c0_i32 to %4 step %c1_i32  : i32 {
      ...
      %78 = arith.muli %73, %c-845247145_i32 : i32
      %79 = tt.bitcast %77 : i32 -> i32
      %80 = arith.cmpi slt, %79, %c0_i32 : i32
      %81 = arith.extsi %79 : i32 to i64
      %82 = arith.subi %c0_i64, %81 : i64
      %83 = arith.cmpi sle, %82, %c2147483647_i64 : i64
      %84 = arith.cmpi sge, %82, %c-2147483648_i64 : i64
      %85 = arith.andi %83, %84 : i1
      tt.assert %85, "int32 overflow detected for operation sub" : i1
      %86 = arith.subi %c-1_i32, %79 : i32
      %87 = arith.select %80, %86, %79 : i32
      %88 = arith.sitofp %87 : i32 to f32
      %89 = arith.mulf %88, %cst : f32
      %90 = tt.bitcast %78 : i32 -> i32
      %91 = arith.cmpi slt, %90, %c0_i32 : i32
      %92 = arith.extsi %90 : i32 to i64
      %93 = arith.subi %c0_i64, %92 : i64
      %94 = arith.cmpi sle, %93, %c2147483647_i64 : i64
      %95 = arith.cmpi sge, %93, %c-2147483648_i64 : i64
      %96 = arith.andi %94, %95 : i1
      tt.assert %96, "int32 overflow detected for operation sub" : i1
      %97 = arith.subi %c-1_i32, %90 : i32
      %98 = arith.select %91, %97, %90 : i32
      %99 = arith.sitofp %98 : i32 to f32
      %100 = arith.mulf %99, %cst : f32
      %101 = arith.maxnumf %89, %cst_2 : f32
      %102 = arith.mulf %100, %cst_1 : f32
      %103 = math.log %101 : f32
      %104 = arith.mulf %103, %cst_0 : f32
      %105 = math.sqrt %104 : f32
      %106 = math.cos %102 : f32
      %107 = arith.mulf %105, %106 : f32
      %108 = tt.addptr %arg0, %12 : !tt.ptr<bf16>, i32
      %109 = arith.truncf %107 : f32 to bf16
      tt.store %108, %109 : !tt.ptr<bf16>
    }
    tt.return
  }
}

// CHECK-LABEL: func.func @kernel_randn
// CHECK: scf.for {{.*}} {
...
module {
  tt.func public @kernel_randn(%arg0: !tt.ptr<f8E4M3FN> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    %c5_i32 = arith.constant 5 : i32
    %c-766435501_i32 = arith.constant -766435501 : i32
    %c-845247145_i32 = arith.constant -845247145 : i32
    %c-1640531522_i32 = arith.constant -1640531522 : i32
    ...
    scf.for %arg1 = %c0_i32 to %4 step %c1_i32  : i32 {
      ...
      %106 = math.cos %102 : f32
      %107 = arith.mulf %105, %106 : f32
      %108 = tt.addptr %arg0, %12 : !tt.ptr<f8E4M3FN>, i32
      %109 = arith.truncf %107 : f32 to f8E4M3FN
      tt.store %108, %109 : !tt.ptr<f8E4M3FN>
    }
    tt.return
  }
}
...
module {
  tt.func public @kernel_randn(%arg0: !tt.ptr<f8E5M2> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    %c5_i32 = arith.constant 5 : i32
    %c-766435501_i32 = arith.constant -766435501 : i32
    %c-845247145_i32 = arith.constant -845247145 : i32
    %c-1640531522_i32 = arith.constant -1640531522 : i32
    ...
    scf.for %arg1 = %c0_i32 to %4 step %c1_i32  : i32 {
      ...
      %106 = math.cos %102 : f32
      %107 = arith.mulf %105, %106 : f32
      %108 = tt.addptr %arg0, %12 : !tt.ptr<f8E5M2>, i32
      %109 = arith.truncf %107 : f32 to f8E5M2
      tt.store %108, %109 : !tt.ptr<f8E5M2>
    }
    tt.return
  }
}
...
module {
  tt.func public @kernel_randn(%arg0: !tt.ptr<i1> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    %c5_i32 = arith.constant 5 : i32
    %c-766435501_i32 = arith.constant -766435501 : i32
    %c-845247145_i32 = arith.constant -845247145 : i32
    %c-1640531522_i32 = arith.constant -1640531522 : i32
    ...
    scf.for %arg1 = %c0_i32 to %4 step %c1_i32  : i32 {
      ...
      %106 = math.cos %102 : f32
      %107 = arith.mulf %105, %106 : f32
      %108 = tt.addptr %arg0, %12 : !tt.ptr<i1>, i32
      %109 = tt.bitcast %108 : !tt.ptr<i1> -> !tt.ptr<i8>
      %110 = arith.fptosi %107 : f32 to i8
      tt.store %109, %110 : !tt.ptr<i8>
    }
    tt.return
  }
}
...
// CHECK: arith.mulsi_extended {{.*}}, %c-845247145_i32 : i32
// CHECK: arith.xori {{.*}}, {{.*}} : i32
// CHECK: math.log {{.*}} : tensor<1xf32>
// CHECK: math.sqrt {{.*}} : tensor<1xf32>
// CHECK: math.cos {{.*}} : tensor<1xf32>
