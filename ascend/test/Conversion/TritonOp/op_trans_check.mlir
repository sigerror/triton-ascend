...
module {
  tt.func public @fn_npu_102(%arg0: !tt.ptr<f8E4M3FN> {tt.divisibility = 16 : i32} , %arg1: !tt.ptr<f8E4M3FN> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    %cst = arith.constant dense<4> : tensor<1x2x1xi32>
    %cst_0 = arith.constant dense<4> : tensor<8x1x1xi32>
    ...
    %cst_4 = arith.constant dense<8> : tensor<2x1x1xi32>
    %0 = tt.make_range {end = 2 : i32, start = 0 : i32} : tensor<2xi32>
    ...
    %21 = tt.trans %20 {order = array<i32: 1, 0, 2>} : tensor<2x8x4xf8E4M3FN> -> tensor<8x2x4xf8E4M3FN>
    %22 = tt.expand_dims %1 {axis = 1 : i32} : tensor<8xi32> -> tensor<8x1xi32>
    %23 = tt.expand_dims %22 {axis = 2 : i32} : tensor<8x1xi32> -> tensor<8x1x1xi32>
    %24 = arith.muli %23, %cst_1 : tensor<8x1x1xi32>
    %25 = arith.muli %24, %cst_0 : tensor<8x1x1xi32>
    %26 = tt.expand_dims %0 {axis = 0 : i32} : tensor<2xi32> -> tensor<1x2xi32>
    %27 = tt.expand_dims %26 {axis = 2 : i32} : tensor<1x2xi32> -> tensor<1x2x1xi32>
    %28 = arith.muli %27, %cst : tensor<1x2x1xi32>
    %29 = tt.broadcast %25 : tensor<8x1x1xi32> -> tensor<8x2x1xi32>
    %30 = tt.broadcast %28 : tensor<1x2x1xi32> -> tensor<8x2x1xi32>
    %31 = arith.addi %29, %30 : tensor<8x2x1xi32>
    %32 = tt.broadcast %31 : tensor<8x2x1xi32> -> tensor<8x2x4xi32>
    %33 = tt.broadcast %14 : tensor<1x1x4xi32> -> tensor<8x2x4xi32>
    %34 = arith.addi %32, %33 : tensor<8x2x4xi32>
    %35 = tt.splat %arg0 : !tt.ptr<f8E4M3FN> -> tensor<8x2x4x!tt.ptr<f8E4M3FN>>
    %36 = tt.addptr %35, %34 : tensor<8x2x4x!tt.ptr<f8E4M3FN>>, tensor<8x2x4xi32>
    tt.store %36, %21 : tensor<8x2x4x!tt.ptr<f8E4M3FN>>
    tt.return
  }
}


// CHECK-LABEL:   func.func @fn_npu_102
// CHECK-SAME: %arg0: memref<?xf8E4M3FN>
// CHECK-SAME: %arg1: memref<?xf8E4M3FN>
// CHECK: %[[REV:.*]] =  memref.reinterpret_cast %[[X:.*]] to offset: [0], sizes: [8, 2, 4], strides: [8, 4, 1] : memref<?xf8E4M3FN> to memref<8x2x4xf8E4M3FN, strided<[8, 4, 1]>>
...
module {
  tt.func public @fn_npu_102(%arg0: !tt.ptr<f8E5M2> {tt.divisibility = 16 : i32} , %arg1: !tt.ptr<f8E5M2> {tt.divisibility = 16 : i32} ) attributes {noinline = false} {
    %cst = arith.constant dense<4> : tensor<1x2x1xi32>
    %cst_0 = arith.constant dense<4> : tensor<8x1x1xi32>
    %cst_1 = arith.constant dense<2> : tensor<8x1x1xi32>
    %cst_2 = arith.constant dense<4> : tensor<1x8x1xi32>
    ...
    %21 = tt.trans %20 {order = array<i32: 1, 0, 2>} : tensor<2x8x4xf8E5M2> -> tensor<8x2x4xf8E5M2>
    %22 = tt.expand_dims %1 {axis = 1 : i32} : tensor<8xi32> -> tensor<8x1xi32>
    %23 = tt.expand_dims %22 {axis = 2 : i32} : tensor<8x1xi32> -> tensor<8x1x1xi32>
    %24 = arith.muli %23, %cst_1 : tensor<8x1x1xi32>
    %25 = arith.muli %24, %cst_0 : tensor<8x1x1xi32>
    ...
    %33 = tt.broadcast %14 : tensor<1x1x4xi32> -> tensor<8x2x4xi32>
    %34 = arith.addi %32, %33 : tensor<8x2x4xi32>
    %35 = tt.splat %arg0 : !tt.ptr<f8E5M2> -> tensor<8x2x4x!tt.ptr<f8E5M2>>
    %36 = tt.addptr %35, %34 : tensor<8x2x4x!tt.ptr<f8E5M2>>, tensor<8x2x4xi32>
    tt.store %36, %21 : tensor<8x2x4x!tt.ptr<f8E5M2>>
    tt.return
  }
}
...
// CHECK: %[[REV:.*]] =  memref.reinterpret_cast %[[X:.*]] to offset: [0], sizes: [8, 2, 4], strides: [8, 4, 1] : memref<?xf8E5M2> to memref<8x2x4xf8E5M2, strided<[8, 4, 1]>>