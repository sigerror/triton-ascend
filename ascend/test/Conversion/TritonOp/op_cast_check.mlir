...
// CHECK: %[[REV:.*]] = memref.reinterpret_cast %[[X:.*]] to offset: [0], sizes: [4, 16], strides: [16, 1] : memref<?xbf16> to memref<4x16xbf16, strided<[16, 1]>>
...
// CHECK: memref.copy %[[X:.*]], %[[Y:.*]] : memref<2x2x3xi16, strided<[6, 3, 1]>> to memref<2x2x3xi16>
...
// CHECK: memref.copy %[[X:.*]], %[[Y:.*]] : memref<8x8x4xi32, strided<[32, 4, 1]>> to memref<8x8x4xi32>
...
// CHECK: %[[REV:.*]] = memref.alloc() : memref<2x125x4xi64>
