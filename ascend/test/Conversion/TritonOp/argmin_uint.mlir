...
module {
  tt.func public @triton_argmin_1d8(%arg0: !tt.ptr<i8> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":22:0), %arg1: !tt.ptr<i32> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":22:0), %arg2: i32 {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":22:0)) attributes {noinline = false} {
    ...
    ^bb0(%arg3: i8 loc(callsite(#loc21 at #loc8)), %arg4: i32 loc(callsite(#loc21 at #loc8)), %arg5: i8 loc(callsite(#loc21 at #loc8)), %arg6: i32 loc(callsite(#loc21 at #loc8))):
      ...
      %11 = arith.cmpi ult, %arg3, %arg5 : i8 loc(#loc48)
...
// CHECK: %[[VAL_2:[A-Za-z0-9_]+]] = arith.cmpi ult, %[[VAL_0]], %[[VAL_1]] : i8
// ---------

module {
  tt.func public @triton_argmin_1d(%arg0: !tt.ptr<i16> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0), %arg1: !tt.ptr<i32> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0), %arg2: i32 {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0)) attributes {noinline = false} {
    %0 = tt.get_program_id x : i32 loc(#loc1)
    %1 = tt.make_range {end = 16 : i32, start = 0 : i32} : tensor<16xi32> loc(#loc2)
    %2 = tt.splat %0 : i32 -> tensor<16xi32> loc(#loc3)
    %3 = arith.addi %2, %1 : tensor<16xi32> loc(#loc3)
    ...
    ^bb0(%arg3: i16 loc(callsite(#loc21 at #loc8)), %arg4: i32 loc(callsite(#loc21 at #loc8)), %arg5: i16 loc(callsite(#loc21 at #loc8)), %arg6: i32 loc(callsite(#loc21 at #loc8))):
      ...
      %9 = arith.cmpi slt, %arg4, %arg6 : i32 loc(#loc46)
      %10 = arith.andi %8, %9 : i1 loc(#loc47)
      %11 = arith.cmpi ult, %arg3, %arg5 : i16 loc(#loc48)
      %12 = arith.ori %11, %10 : i1 loc(#loc49)
...
// CHECK: %[[VAL_2:[A-Za-z0-9_]+]] = arith.cmpi ult, %[[VAL_0]], %[[VAL_1]] : i16
// ---------


module {
  tt.func public @triton_argmin_1d(%arg0: !tt.ptr<i32> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0), %arg1: !tt.ptr<i32> {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0), %arg2: i32 {tt.divisibility = 16 : i32} loc("/home/l30058175/wxue/test_u8_argmin.py":45:0)) attributes {noinline = false} {
    %0 = tt.get_program_id x : i32 loc(#loc1)
    %1 = tt.make_range {end = 16 : i32, start = 0 : i32} : tensor<16xi32> loc(#loc2)
    %2 = tt.splat %0 : i32 -> tensor<16xi32> loc(#loc3)
    %3 = arith.addi %2, %1 : tensor<16xi32> loc(#loc3)
    ...
    ^bb0(%arg3: i32 loc(callsite(#loc21 at #loc8)), %arg4: i32 loc(callsite(#loc21 at #loc8)), %arg5: i32 loc(callsite(#loc21 at #loc8)), %arg6: i32 loc(callsite(#loc21 at #loc8))):
      ...
      %9 = arith.cmpi slt, %arg4, %arg6 : i32 loc(#loc46)
      %10 = arith.andi %8, %9 : i1 loc(#loc47)
      %11 = arith.cmpi ult, %arg3, %arg5 : i32 loc(#loc48)
      %12 = arith.ori %11, %10 : i1 loc(#loc49)
...
// CHECK: %[[VAL_2:[A-Za-z0-9_]+]] = arith.cmpi ult, %[[VAL_0]], %[[VAL_1]] : i32
// ---------