...
module {
		...
		%33 = math.erf %32 : tensor<2x29x4xf8E5M2>
...
// CHECK: %[[ERF_RESULT:[A-Za-z0-9_]+]] = math.erf %[[TENSOR_INPUT]] : tensor<2x29x4xf8E5M2>
...
module {
		...
		%31 = tt.addptr %30, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		%32 = tt.load %31 : tensor<2x29x4x!tt.ptr>
		%33 = math.erf %32 : tensor<2x29x4xf8E4M3FN>
		%34 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%35 = tt.addptr %34, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %35, %33 : tensor<2x29x4x!tt.ptr>
		tt.return
...
// CHECK: %[[ERF_RESULT:[A-Za-z0-9_]+]] = math.erf %[[TENSOR_INPUT]] : tensor<2x29x4xf8E4M3FN>