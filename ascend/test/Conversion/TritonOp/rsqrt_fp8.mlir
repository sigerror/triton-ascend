...
module {
		...
		%26 = math.rsqrt %25 : tensor<2x1x4xf8E4M3FN>
...
// CHECK: %[[RSQRT_RESULT:[A-Za-z0-9_]+]] = math.rsqrt %[[TENSOR_INPUT]] : tensor<2x1x4xf8E4M3FN>
...
module {
		...
		%24 = tt.addptr %23, %22 : tensor<2x1x4x!tt.ptr>, tensor<2x1x4xi32>
		%25 = tt.load %24 : tensor<2x1x4x!tt.ptr>
		%26 = math.rsqrt %25 : tensor<2x1x4xf8E5M2>
		%27 = tt.splat %arg0 : !tt.ptr -> tensor<2x1x4x!tt.ptr>
		%28 = tt.addptr %27, %22 : tensor<2x1x4x!tt.ptr>, tensor<2x1x4xi32>
		tt.store %28, %26 : tensor<2x1x4x!tt.ptr>
		tt.return
...
// CHECK: %[[RSQRT_RESULT:[A-Za-z0-9_]+]] = math.rsqrt %[[TENSOR_INPUT]] : tensor<2x1x4xf8E5M2>