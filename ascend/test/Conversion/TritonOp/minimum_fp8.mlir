...
module {
		...
		%36 = arith.minnumf %32, %35 : tensor<2x29x4xf8E4M3FN>
...
// CHECK: %[[MAX_RESULT:[A-Za-z0-9_]+]] = arith.minnumf %[[TENSOR_OP1]], %[[TENSOR_OP2]] : tensor<2x29x4xf8E4M3FN>
...
module {
		...
		%34 = tt.addptr %33, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		%35 = tt.load %34 : tensor<2x29x4x!tt.ptr>
		%36 = arith.minnumf %32, %35 : tensor<2x29x4xf8E5M2>
		%37 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%38 = tt.addptr %37, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %38, %36 : tensor<2x29x4x!tt.ptr>
		tt.return
...
// CHECK: %[[MAX_RESULT:[A-Za-z0-9_]+]] = arith.minnumf %[[TENSOR_OP1]], %[[TENSOR_OP2]] : tensor<2x29x4xf8E5M2>