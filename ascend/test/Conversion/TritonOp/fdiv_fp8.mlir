...
module {
		...
		%36 = arith.divf %32, %35 : tensor<2x29x4xf8E5M2>
		%37 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%38 = tt.addptr %37, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %38, %36 : tensor<2x29x4x!tt.ptr>
		tt.return
	}
}

// CHECK: %[[ALLOC_DIVIDEND:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E5M2>
// CHECK: %[[TENSOR_DIVIDEND:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_DIVIDEND]] restrict writable : memref<2x29x4xf8E5M2>

// CHECK: %[[ALLOC_DIVISOR:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E5M2>
// CHECK: %[[TENSOR_DIVISOR:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_DIVISOR]] restrict writable : memref<2x29x4xf8E5M2>

// CHECK: %[[DIV_RESULT:[A-Za-z0-9_]+]] = arith.divf %[[TENSOR_DIVIDEND]], %[[TENSOR_DIVISOR]] : tensor<2x29x4xf8E5M2>
...
module {
		...
		%34 = tt.addptr %33, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		%35 = tt.load %34 : tensor<2x29x4x!tt.ptr>
		%36 = arith.divf %32, %35 : tensor<2x29x4xf8E4M3FN>
		%37 = tt.splat %arg0 : !tt.ptr -> tensor<2x29x4x!tt.ptr>
		%38 = tt.addptr %37, %29 : tensor<2x29x4x!tt.ptr>, tensor<2x29x4xi32>
		tt.store %38, %36 : tensor<2x29x4x!tt.ptr>
		tt.return
...
// CHECK: %[[ALLOC_DIVIDEND:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E4M3FN>
// CHECK: %[[TENSOR_DIVIDEND:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_DIVIDEND]] restrict writable : memref<2x29x4xf8E4M3FN>

// CHECK: %[[ALLOC_DIVISOR:[A-Za-z0-9_]+]] = memref.alloc() : memref<2x29x4xf8E4M3FN>
// CHECK: %[[TENSOR_DIVISOR:[A-Za-z0-9_]+]] = bufferization.to_tensor %[[ALLOC_DIVISOR]] restrict writable : memref<2x29x4xf8E4M3FN>

// CHECK: %[[DIV_RESULT:[A-Za-z0-9_]+]] = arith.divf %[[TENSOR_DIVIDEND]], %[[TENSOR_DIVISOR]] : tensor<2x29x4xf8E4M3FN>