...
## 2.Python wheel 安装 Triton-Ascend
...
运行Triton示例
 ...
 ```
## 3.源代码安装 Triton-Ascend
通过上面步骤，您已经快速安装triton-ascend成功了。如果您需要对 triton-ascend 进行开发或自定义修改，则应采用源代码编译安装的方法。
这种方式允许您根据项目需求调整源代码，并编译安装定制化的 triton-ascend 版本。
